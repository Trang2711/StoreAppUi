...
const CardItemFlashSale = ({ props, navigation, specialKey }: any) => {
    ...
    >
      ...
      >
        <View style={styles.flash}>
          ...
          <Text style={styles.dealsDiscount}>
            -{Math.round(((price - discount_price) * 100.0) / price)}%
          </Text>
        </View>
      </ImageBackground>
