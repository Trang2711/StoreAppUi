...
export default function AddingToCartModal({ colors, navigation, onClick }: any) {
    ...
    return (
        <>
            <View style={styles.footer}>
                <TouchableOpacity style={styles.chatBtn} onPress={() => navigation.navigate('BottomNav', { screen: 'Chat' })}>
            ...
            <View style={modalVisible && { position: 'absolute', backgroundColor: 'rgba(0, 0, 0, 0.7)', height: height, width: width, zIndex: 100 }}></View>
            <Modal
                animationType="slide"
                transparent={true}
            ...
            >
                <View style={{ position: 'relative', top: height - 175, backgroundColor: 'white' }}>
