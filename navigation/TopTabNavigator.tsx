...
export default function TopTabNavigator() {
  return (
    <TopTabStack.Navigator>
      <TopTabStack.Screen name="PaymentScreen" component={PaymentScreen} options={{ title: 'Thanh toán' }} />
      <TopTabStack.Screen name="AddressScreen" component={AddressScreen} options={{ title: 'Địa chỉ giao hàng' }} />
